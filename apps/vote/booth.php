...
if(!function_exists('symp_boothUI')) {
   ...
   function symp_boothUI($p, $rand,$returntourl) {
      ...
      global $s_barimg,$s_barhite, $s_showtotal, $s_dirurl, $s_polllist, $s_resultnums,
      $symp_lang3, $symp_lang7,  $s_barimg_dir;
      ...
      $o.= "style=\"font-size: 10px\" /> <a href=\"$returntourl?wtpss=$p[pid]\">View Results</a>\n</font>\n";

      $o.= "</td></tr></table>\n</td></tr></table>\n";
      $o.= "<input type=\"hidden\" name=\"pid\" value=\"$p[pid]\" />\n";
      $o.= "<input type=\"hidden\" name=\"ref\" value=\"$returntourl?wtpss=$p[pid]\" />\n";
      $o.= "</form>\n";
   ...
   function symp_get_booth($pid,$returntourl,$showstatus) {
      ...
      if($showstatus) {
         ...
         return symp_boothUI($p, $rand,$returntourl);
      }
   } 
   ...
   function display_booth($pid,$returntourl,$showstatus) {
      echo symp_get_booth($pid,$returntourl,$showstatus);
   }
