...
// guestbook config file

// Get this info here from webmasterthings user database & passed data
require ("../wtuserinfo.php");				// get user info based on 'wt_owner'



// cleanup in x days
$tcmCleanupDays=0; // will clean out entries older than x days - 0 won't clean out

// GB Parameters                                                                                                       
$adminpass      	= "scubag";                	// Password for Administration                                                 
#$guestbook_head 	= "New Baby Guestbook";           	// Guestbook Header (Name)
#$gb_desc			= "Baby's Guestbook";// Enter your description here                                                     
$url_to_start   	= "http://www.webmasterthings.com/apps/guestbook/guestbook.php?firstowner=$wt_owner&secondowner=$wt_owner2&gbheader=$gbheader&owneremail=$owneremail&rurl=$rurl&rtext=".stripslashes($rtext); 		// NO trailing slashes - 
$gb_notify      	= "$owneremail";       // leave it empty -> disable email owner notify                                    



// mySql Configuration                                                                                           
$server         = "$wtserver";           	// Your mySQL Server, most cases "localhost"
$db_user        = "$wtdb_user";           	// Your mySQL Username
$db_pass        = "$wtdb_pass";           	// Your mySQL Password
$database       = "$wtdatabase";             	// Database Name
$tablename		= "wt_guestbook";			// table name
...
$table_width	= "595";			// enter value in pix (e.g. "600") or in % (e.g. "80%")
