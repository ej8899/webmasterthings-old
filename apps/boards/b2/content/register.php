...
switch ($step)
  {
    ...
    case 1:
      ...
      echo "                </TD>\n"
         ...
         . "              <B><A href=\"?wt_owner=$wt_owner&pid=register&step=2\">Agree</A> | <A href=\"?wt_owner=$wt_owner&pid=view_forums\">Cancel</A></B>\n"
         . "            </CENTER>\n";
      break;

    /* Display the form for the user to fill out */
    case 2:
      ShowRegistrationForm( $username, $password, $confirm_password, $email, $location, $occupation, $homepage, $picture, $interests, $aim, $icq, $yahoo, $signature, $include_sig,$wt_owner );
      break;
...
$picture=$newfilename;
              ...
              echo "            <CENTER class=\"regular_text\">\n"
                 ...
                 . "              <A href=\"index.php?wt_owner=$wt_owner\">Click here to log in!</A>\n"
                 . "            </CENTER>\n"
                 . "            <BR>\n";
...
ShowRegistrationForm( $username, $password, $confirm_password, $email, $location, $occupation, $homepage, $picture, $interests, $aim, $icq, $yahoo, $signature, $include_sig,$wt_owner )
{
  ...
  echo "            <SCRIPT language=\"JavaScript\">\n"
     ...
     . "              }\n"
     . "            </SCRIPT>\n"
     . "            <FORM action=\"index.php?pid=register&step=4\" enctype=\"multipart/form-data\" method=\"POST\" name=\"registration\">\n"
     . "              <TABLE cellpadding=\"5\" cellspacing=\"0\" width=\"100%\" border class=\"table_border\">\n"
     . "                <TR class=\"table_header\">\n"
     ...
     . "                  <TD width=\"50%\" nowrap><INPUT type=\"file\" name=\"picture1url\" value=\"$picture\" maxlength=\"128\" size=\"50\"> <FONT class=\"small_text\">Max: 128 characters</FONT></TD>\n"
     . "                </TR>\n"
     . "                <TR bgcolor=\"" . TABLE_COLOR_1 . "\" class=\"regular_text\">\n"
  ...
  echo "                          <INPUT type=\"checkbox\" name=\"include_sig\" value=\"1\"$checked> Include Signature on New Posts?\n"
     ...
     . "                </TR>\n"
     . "              </TABLE>\n<input type=hidden name=wt_owner value=$wt_owner>\n"
     . "              <CENTER><BR><INPUT type=\"Submit\" value=\"Submit Information\" onClick=\"return CheckForm();\"></CENTER>\n"
     . "            </FORM>\n";
}
