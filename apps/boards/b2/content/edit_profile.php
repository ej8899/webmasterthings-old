...
switch ($step)
  {
    ...
    case 2:
      ShowProfileForm( $username, $password, $confirm_password, $email, $location, $occupation, $homepage, $picture, $interests, $aim, $icq, $yahoo, $signature, $include_sig,$wt_owner );
      break;
...
PreviewSection ( $section_value, $section_title, $the_color )
{
  ...
  if ($section_title == "Picture")
    {
        echo "                    <BR><BR>\n";
      echo "                    <TABLE border class=\"table_border\" cellspacing=\"0\" cellpadding=\"0\"><TR><TD><A href=\"$section_value\" target=\"_blank\"><IMG src=\"showthumb.php?newwidth=250&image=$section_value&t=meobscene.com\"  border=\"0\"></A></TD></TR></TABLE>\n";
    }
