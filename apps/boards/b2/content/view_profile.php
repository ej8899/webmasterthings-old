  ...
  switch ($section_title)
    {
      ...
      case "Picture":
        /* Show the image!! */
        echo "                  <TABLE cellspacing=\"0\" cellpadding=\"0\" border class=\"table_border\"><TR><TD><IMG src=\"showthumb.php?newwidth=250&image=$section_value&t=meobscene.com\" border=\"0\"></TD></TR></TABLE>\n";
        break;
