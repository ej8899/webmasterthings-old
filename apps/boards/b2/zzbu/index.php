...
echo "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">\n"
   . "<HTML>\n"
   . "  <HEAD>\n"
   . "    <TITLE>$wtdb[sitename] Message Board [ powered by WebmasterThings.com - board " . VERSION . " ]</TITLE>\n"
   ...
   . "    <table border=0 bgcolor=black cellpadding=2 cellspacing=0 width=650><tr><td><table border=0 width=100% bgcolor=white cellpadding=0 cellspacing=0><tr><td><TABLE align=\"center\" valign=\"top\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" bgcolor=". HEADER_BACKGROUND . ">\n";
