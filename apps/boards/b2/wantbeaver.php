...
<html>
<head>   <TITLE>WantBeaver.com Message Board [ powered by WebmasterThings.com - board " . VERSION . " ]</TITLE>\n"
   . "    <STYLE>\n"
   . "      A\n"
   . "        {\n"
   . "          color: " . LINK_COLOR . ";\n"
...
echo " </head><body>   <table border=0 bgcolor=\"#585858\" cellpadding=2 cellspacing=0 width=600><tr><td><table border=0 width=100% bgcolor=white cellpadding=0 cellspacing=0><tr><td><TABLE align=\"center\" valign=\"top\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" bgcolor=". HEADER_BACKGROUND . ">\n";
...
echo "                            \n"
   ...
   . "                  <TR>\n"
   . "                    <TD valign=\"middle\"><FONT class=\"small_text\"><a href=\"http://www.wantbeaver.com/members.php\"><strong>wantbeaver.com - members area</strong></a>"; ?> <?php include("http://www.webmasterthings.com/apps/counter/counter.php?name=cbbs"); ?> <?php echo "<BR><BR></font>\n";
