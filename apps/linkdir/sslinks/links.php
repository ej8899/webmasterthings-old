...
if($wt_owner)
{
	$wtownerinfo=$wt_owner;
}
$wtownerinfo=$wt_owner;
// echo "<BR>DEBUG: wtownerinfo|$wtownerinfo|<BR>";
...
if ($action == "addlink")
{
	add_link($link_name, $link_url, $link_desc, $link_cat, $link_recommended,$wt_owner,$password);
}

if ($action == "addcat")
{
	add_cat($lcat_name, $lcat_header, $lcat_cat, $lcat_ranking,$wt_owner);
}
