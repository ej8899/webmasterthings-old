...
For more information read the gpl.txt file included with this distribution, 
or check out the GNU website:  http://www.gnu.org/

The script is copyright (or copyleft) Simon Willison, 2001.

If you use the script on your site, I would appreciate the following:

1.  Tell me that you are using it!  Use the "Suggest a link" feature
on the ssLinks website or drop me an e-mail at skunk@sslinks.co.uk

2.  I would appreciate it if you kept the "Powered by ssLinks v1.2" text
visible in the footer of all pages generated by ssLinks.  This isn't 
mandatory but would be greatly appreciated.

Feedback / Bug Reports / Support Issues:
----------------------------------------

I'd love to hear feedback about my script, ranging from where you are using
it to what you think of it to features that you'd like improved.  If you have
any problems using the script I will try to respond to them but I can't promise
a personal reply to every e-mail.

If you want guaranteed help I suggest using the forum on the ssLinks website:

http://www.sslinks.co.uk/

Hopefully all queries posted on this forum will get a response, either from me
or from another ssLinks user.
