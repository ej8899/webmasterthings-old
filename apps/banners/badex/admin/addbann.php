...
?>
		<html><head><title><? echo"$exchange_name"; ?> - Add Banner</title><LINK REL=stylesheet HREF="<?echo "$base_url" ?>/style.css" TYPE="text/css">
</head>
<body>
<br><br>
<?
...
?>
<center>The Follwing Banner has been added to the account:<br>
