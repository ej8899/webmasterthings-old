...
// Add a user
if($_POST['action'] == "add_user" && isset($_POST['do']) && $_POST['do']=="add") {
...
echo "	</tbody></table>";
	...
	// Flag to check whether there is only one user
	if($num == 1) { $count_flag=true; } else { $count_flag=false; }
