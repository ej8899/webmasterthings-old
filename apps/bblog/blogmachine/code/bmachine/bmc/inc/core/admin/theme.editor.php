...
<table width="100%" border="0" style="float:right" cellpadding="3" cellspacing="0" summary="User list">
	...
	<tr>
			...
			<div>
<br />
<strong><?php echo $lang['admin_editor_dir']; ?></strong></br >
...
<br />
<strong><?php echo $lang['admin_editor_files']; ?></strong></br >
...
?>
<br /><br />
<strong><?echo str_replace("%title%",$file,$lang['post_edit']); ?></strong><br />
