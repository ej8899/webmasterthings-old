...
<span class="post_title"><a name="<?php echo $i_post['id']; ?>" href="<?php echo BLOG_FILE; ?>?id=<?php echo $i_post['id']; ?>" title="<?php echo $title; ?>"><?php echo $title; ?></a></span><br />
<?php echo $date; ?><br />
<?php echo $lang['posted_by']; ?> <a href="profile.php?id=<?php echo $i_post['author']; ?>"><?php echo $user_name; ?></a> <?php echo $lang['str_in']; ?> 
<a href="<?php echo BLOG_FILE; ?>?cat=<?php echo $i_post['cat']; ?>" title="<?php echo $cat_name; ?>"><?php echo $cat_name; ?></a>
