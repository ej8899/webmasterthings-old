...
?>
	<img src="<?php echo $bmc_vars['c_urls']."/files/".$user_info['user_pic']; ?>" alt="<?php echo $user_info['user_login']; ?>" /><br />
<?php
		}
	}
?>
...
<br />
<?php echo $lang['user_joined']; ?> :<br /><strong><?php echo bmcDate($user_info['date']); ?></strong>
...
<br /><br />
<?php echo $lang['user_url']; ?> :<br /><a href="<?php echo $user_info['user_url']; ?>"><strong><?php echo $user_info['user_url']; ?></strong></a>
...
// Show the email if necessary
	...
	$email=str_replace("@","&#064;", $user_info['user_email']);

	?>

<br /><br />
<?php echo $lang['user_email']; ?> :<br /><a href="mailto:<?php echo $email; ?>" title="<?php echo $lang['user_email']." ".$email; ?>"><strong><?php echo $email; ?></a></strong>
...
<?php
	...
	if(!empty($user_info['user_birth'])) {
		...
		if($year > 1970) {
			...
			$b_day=$lang['caln_long_'.strtolower(date("w",$stamp)+1)];
			$b_month=$lang['caln_lmonth_'.strtolower(date("M",$stamp))];
...
<?php echo nl2br(wordwrap(htmlentities($user_info['user_profile']), $bmc_vars['c_wrap'],"\n",1)); ?>
